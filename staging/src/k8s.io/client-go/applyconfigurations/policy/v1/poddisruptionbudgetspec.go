...
type PodDisruptionBudgetSpecApplyConfiguration struct {
	...
	AvailabilityMode *policyv1.AvailabilityMode `json:"availabilityMode,omitempty"`
}
...
func (b *PodDisruptionBudgetSpecApplyConfiguration) WithAvailabilityMode(value policyv1.AvailabilityMode) *PodDisruptionBudgetSpecApplyConfiguration {
